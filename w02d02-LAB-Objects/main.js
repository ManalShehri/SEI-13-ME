...
books = [
    { title : "Don Quixote by Miguel de" , auther : "Manal" , alreadyRead : false},
    { title : "Tale of Two Cities" , auther : "Manal" , alreadyRead : true},
    { title : "The Lord of the Rings" , auther : "ALi" , alreadyRead : false},
    { title : "The Little Prince by Antoine" , auther : "Mohammed" , alreadyRead : true}
];
...
recipe = { title : "cake" , servings  : 3 , ingredients :['2 eggs', 'flower','suger','oil']}
...
movies = { title : "La La Lamd" , duration   : 120 , stars:['Puff', 'Jackie']}

console.log(movies.title+ ' lasts for ' +movies.duration+'minutes. Stars ' +movies.stars.join())
...
console.log(tweet.user.friends_count);